...
const leftIrisDiv = document.getElementsByClassName('left-iris')[0];
...
const rightIrisDiv = document.getElementsByClassName('right-iris')[0];
...
// Iris Sizes
leftIris.style.height = `${(leftEye.clientHeight) * 0.4}px`;
rightIris.style.height = `${(rightEye.clientHeight) * 0.4}px`;
